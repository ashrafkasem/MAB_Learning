from MAP_core.policies.linucb_hybrid import linucb_hybrid_policy
import pandas as pd
import numpy as np

def ctr_simulator(K_arms, d, k, alpha, epochs, top_movies_index, top_movies_features, steps_printout, filtered_data, user_features):
    # Initiate policy
